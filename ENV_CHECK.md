...
jonathan@robotics-vm:~$ colcon version-check
...
## cmake –version
jonathan@robotics-vm:~$ cmake --version
cmake version 3.28.3

CMake suite maintained and supported by Kitware (kitware.com/cmake).

## python3 –version
jonathan@robotics-vm:~$ python3 --version
Python 3.12.3

## ros2 –version
jonathan@robotics-vm:~$ ros2 --version
usage: ros2 [-h] [--use-python-default-buffering]
            Call `ros2 <command> -h` for more detailed usage. ...
ros2: error: unrecognized arguments: --version

## printenv ROS_DISTRO
jonathan@robotics-vm:~$ printenv ROS_DISTRO
jazzy

## timeout 3 ros2 run demo_nodes_cpp talker || echo “done”
jonathan@robotics-vm:~$ timeout 3 ros2 run demo_nodes_cpp talker || echo "done"

[INFO] [1783369302.457257190] [talker]: Publishing: 'Hello World: 1'
[INFO] [1783369303.456433139] [talker]: Publishing: 'Hello World: 2'
[INFO] [1783369304.064829511] [rclcpp]: signal_handler(SIGINT/SIGTERM)
done